...
*When upgrading from v0.1x to v0.20, your preferences for 'Keep Textpattern thumbnails in sync with default profile' will be removed. Please visit the _Tools/Prefs_ area to reinstate the behaviour you desire.*
